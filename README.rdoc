...
== Passing tests
 66 passing Rspec and 8 Cucumber Tests
...
15th March
* Fixed some tests in user_spec.rb and posting_spec.rb
* Added test to posting_spec
* Added comments to some code to shown who worked on what
* Fixed title for posting

14th March
* Fixed some tests in User_Spec and Authentication_pages_spec.rb
* Edited layout
* Removed two useless tests
* Changed Log in/Log out back to Sign in/Sign out - Was causing failing tests and did not match the routes which may lead to confusion
